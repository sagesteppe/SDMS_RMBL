...
spp_occurrences <- st_read( here("data/processed/spp_occurences_no_duplicates.shp"), quiet = T) %>% st_transform(32613)
```
...
```{r}
st_write(spp_occurrences_reg_random, here("data/processed/spp_occurences_regression.shp"), append = F)
st_write(spp_occurrences, here("data/processed/spp_occurences.shp"), append = F)
```
