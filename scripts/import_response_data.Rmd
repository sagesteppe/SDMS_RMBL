...
ecoregion_bound <- readOGR(here('data/processed/SoRo_ecoregion_bound.shp'))
...
We can now write out these species occurence records for more trimming and analyses