...
abc <- spp_pres_sampler(target = focal_records, 
                        range = poly100_t_dist_sub, 
                        tSS = 87, rSS = 0.9, replicates = 250
                        )


rm(focal_records, grid2rm, grids_out, poly100, poly100_t, public_lands_ownership, recs2sample, target_grid)
