...
rm(spec.test, spec.test1, museum_results)
```


compare and clean up species lists
...
accepted_target <- target_spp_CLEAN %>% 
  filter(scientificName %in% rmbl_spp_CLEAN$scientificName)
accepted_rmbl <- rmbl_spp_CLEAN %>% 
  filter(scientificName %in% target_spp_CLEAN$scientificName)

quest_rmbl <- rmbl_spp_CLEAN %>% 
  filter(!scientificName %in% target_spp_CLEAN$scientificName)

quest_target <- target_spp_CLEAN %>% 
  filter(!scientificName %in% rmbl_spp_CLEAN$scientificName)
```
